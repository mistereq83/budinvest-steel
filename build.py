...
PAGE_SPECS = [
    ...
    ('o-nas', {
        ...
        'en': ('src/en/about.html', 'about.html'),
        'de': ('src/de/o-nas.html', 'ueber-uns.html'),
    }),
    ('uslugi', {
        'pl': ('src/uslugi.html', 'uslugi.html'),
        'en': ('src/en/services.html', 'services.html'),
    ...
    ('uslugi/konstrukcje-stalowe', {
        ...
        'en': ('src/en/services/steel-structures.html', 'services/steel-structures.html'),
    ...
    ('uslugi/zbiorniki-cisnieniowe', {
        ...
        'en': ('src/en/services/pressure-vessels.html', 'services/pressure-vessels.html'),
    ...
    ('uslugi/rurociagi-przemyslowe', {
        ...
        'en': ('src/en/services/industrial-pipelines.html', 'services/industrial-pipelines.html'),
    ...
    ('uslugi/obrobka-metali', {
        ...
        'en': ('src/en/services/metal-processing.html', 'services/metal-processing.html'),
